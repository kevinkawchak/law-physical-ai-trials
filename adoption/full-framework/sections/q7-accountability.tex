...
harmonised guideline aligns the same roles with international good clinical practice
...
\end{cfwfig}
\vspace{-0.2cm}
\cfwcaption{Figure 9. Where accountability sits (Mermaid 13 reproduced as colored
TikZ): clinician, sponsor, and developer obligations converge on a signed standard
...
IRB & Ethical approval and the conditions attached to it & Approval letter and standard operating procedure\\
Auditor & Independent confirmation that the record matches events & Audit report against the hash chain\\
\bottomrule
\end{tabularx}
\caption{Responsibility allocation: what each party is responsible for and where
that responsibility is recorded, anchored by the signed standard operating
procedure and the audit trail.}
