...
judgment and machine recognition only earns its place at the bedside when
the machine has been shown to perform, not in the abstract, but on the question and
the population by the clinician \cite{topol2019high}.
...
\begin{cfwfig}
\node[cfone] (a) at (0,0) {Bench}; \node[cftwo] (b) at (4,0) {Retrospective};
\node[cftwo] (c) at (8,0) {Prospective}; \node[cfact] (d) at (12,0) {Assurance 172/172};
\node[cfhope] (e) at (8,-2.0) {Competence established};
\draw[cfedge] (a)--(b); \draw[cfedge] (b)--(c); \draw[cfedge] (c)--(d);
\draw[cfedge] (d) to[out=-90,in=0] (e.east);
\end{cfwfig}
\vspace{-0.8cm}
\cfwcaption{Figure 3. The competence evidence stack: bench accuracy, retrospective cohort, prospective on-site
...
\footnotesize
\begin{tabularx}{\textwidth}{@{}L{3cm} Y L{5.4cm}@{}}
\toprule
...
and by the discipline of validating on the local population.
