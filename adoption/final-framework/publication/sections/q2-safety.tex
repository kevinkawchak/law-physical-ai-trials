...
existence of the hard stop, and the team behind it, can be confirmed by an
outside party.
...
\end{cfwfig}
\vspace{-0.8cm}
\cfwcaption{Figure 4. The catastrophe-predicate gate: a candidate action that matches the irreversible-harm predicate
...
Gates 5 to 9 (standards binding) & Conformance to external standards, protocol constraints, signed standard operating procedure & The deviation is logged and the action is blocked pending correction\\
