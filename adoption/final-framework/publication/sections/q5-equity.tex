...
and the disparity itself becomes a surveillance priority.
...
\end{cfwfig}
\vspace{-0.75cm}
\cfwcaption{Figure 7. Subgroup equity:
...
\footnotesize
\begin{tabularx}{\textwidth}{@{}L{2.65cm} Y L{5.9cm}@{}}
\toprule
\textbf{Subgroup axis} & \textbf{Metric reported} & \textbf{Action if disparity}\\
\midrule
Age & Accuracy and calibration by age band, older patients & Escalate and add the band to surveillance\\
...
Writing per-subgroup reporting and bias surveillance into the
