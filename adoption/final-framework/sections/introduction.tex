...
\draw[cfedged] (esc.south) to[out=-90,in=-90,looseness=1.1] (b.south);
\end{cfwfig}
\vspace{-0.15cm}
...
\end{cfwfig}
\vspace{-0.15cm}
\cfwcaption{Figure 2. The eight confidence questions (Mermaid 02 reproduced as
colored TikZ). The answers accumulate into calibrated trust.}
