...
\midrule
Mandate & Three named gaps in existing law (embodiment and sequencing, financial data, cost asymmetry), tied to the record on preventable medical error.\\
Authority & A commerce-power amendment to the FD\&C Act adding section 515D, with a rule of construction and a State savings clause that preserve existing law.\\
Safety & Verification before generation: the ten-gate schedule bound to consensus standards and the three hard catastrophe predicates.\\
Fiscal & A 58 million dollar authorization, no net mandatory spending, no new fee, and a verification cost roughly nineteen times below conventional review.\\
...
Passage path & Ordinary regular order in both chambers, known vote thresholds, a defined implementation runway, and a demonstrated platform.\\
\bottomrule
\end{tabularx}
\caption{The synthesis: each of the eight passage questions and the provision, score
line, or evidence in H. R. 9510 that answers it.}
\label{tab:synthesis}
\end{table}
