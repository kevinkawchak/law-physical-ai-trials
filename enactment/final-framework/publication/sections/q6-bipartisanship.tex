...
answers two caucuses from different premises.
...
safety rationale converge on the same provision.}
\label{fig:converge}
...
member and a safety-minded member can support on their own terms, with no
